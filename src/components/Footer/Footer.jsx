      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10 grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            ...
            <li>
              <Link to="/range" className="hover:text-white transition">
                Range of KWS
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <div className="mt-4 text-sm space-y-2 text-gray-400">
            <p className="flex items-center gap-2">
              <Phone size={18} />{" "}
              <a href="tel:+918420906352" className="hover:text-white">
                +91 84209 06352
              </a>
            </p>
            <p className="flex items-center gap-2">
              <Phone size={18} />{" "}
              <a href="tel:+919558214868" className="hover:text-white">
                +91 95582 14868
              </a>
            </p>
            <p className="flex items-center gap-2">
              <Phone size={18} />{" "}
              <a href="tel:+917439186072" className="hover:text-white">
                +91 74391 86072
              </a>
            </p>
            <p className="flex items-center gap-2">
              <Mail size={18} />{" "}
              <a
                href="mailto:saleslluxeliving@gmail.com"
                className="hover:text-white"
              >
                saleslluxeliving@gmail.com
              </a>
            </p>
            <p>
              📍 2/35, Samajgarh Park, near Samajgarh Park,
              <br />
