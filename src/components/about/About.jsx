    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
          ...
          <motion.h1
            className="text-4xl md:text-5xl font-bold text-gray-900 text-center tracking-tight mb-12"
            initial="hidden"
            whileInView="visible"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              {/* Intro paragraph */}
              <p>
                At <span className="font-semibold">LLuxe Living</span>, we craft
                timeless interiors that blend functionality with aesthetics.
                Whether it's your home or office, we believe every space should
                reflect elegance, comfort, and personality.
              </p>

              {/* Service description */}
              <p>
                Our expert designers curate personalized solutions, transforming
                ideas into breathtaking realities. Let us elevate your living
                and working environment with a touch of sophistication.
              </p>
